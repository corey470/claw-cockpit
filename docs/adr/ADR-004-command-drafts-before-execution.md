...
- Warning/doctor commands stay preview-only until each action gets its own catalog entry. Gateway restart, deep security audit, main model repair, and Discord plugin install are the first runnable warning fixes.
